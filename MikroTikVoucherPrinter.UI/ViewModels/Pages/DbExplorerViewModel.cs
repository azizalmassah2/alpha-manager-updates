...
/// </summary>
public partial class DbExplorerViewModel : BaseViewModel
{
    ...
    public DbExplorerViewModel(ILogger<DbExplorerViewModel> logger, ISettingsService settingsService) : base(logger)
    {
    ...
    private void ShowUserReport(System.Data.DataRowView? row)
    {
        ...
        {
            var window = new MikroTikVoucherPrinter.UI.Views.Windows.UserReportWindow(userName);
