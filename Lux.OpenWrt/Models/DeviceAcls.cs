...
public class DeviceAcls
{
    ...
    /// </summary>
    public static DeviceAcls FromUciAclArray(IEnumerable<string> grantedMethods)
    {
        var set = new HashSet<string>(grantedMethods, System.StringComparer.OrdinalIgnoreCase);
