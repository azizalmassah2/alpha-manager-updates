...
/// <summary>
/// عكس تحويل Boolean إلى Visibility — true = Collapsed, false = Visible
/// </summary>
...
/// <summary>
/// تحويل كود اللون HEX إلى SolidColorBrush
/// </summary>
public class HexToBrushConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        try
        {
            return (System.Windows.Media.Brush)_brushConverter.ConvertFromString(hex)!;
        }
        catch
        {
            return System.Windows.Media.Brushes.Transparent;
